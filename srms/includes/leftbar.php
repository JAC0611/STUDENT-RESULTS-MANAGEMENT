<div class="left-sidebar bg-black-300 box-shadow ">
  ...
  <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            ...
                                            <li><a href="add-subjectcombination.php"><i class="fa fa fa-server"></i> <span>Add Subject Combinations</span></a></li>
                                            <li><a href="manage-subjectcombination.php"><i class="fa fa fa-server"></i> <span>Manage Subject Combinations</span></a></li>
                                        </ul>
                                    </li>
   <li class="has-children">
